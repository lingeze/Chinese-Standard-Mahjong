...
# Model part
from model import CNNModel, ResNetModel, ResNetModelDeep
# Botzone interaction
import numpy as np
import torch
...
if __name__ == '__main__':
    ...
    if is_resnet:
        if num_resblocks > 12:
            model = ResNetModelDeep(in_channels=in_channels, num_resblocks=num_resblocks)
        else:
            model = ResNetModel(in_channels=in_channels, num_resblocks=num_resblocks)
    else:
